...
В приведенном выше примере в обычной функции используется цикл **for**. Цикл выполняет итерацию (перебор), причем справляется с задачей гораздо быстрее, чем рекурсивная функция, поскольку рекурсия совершает множество повторных вызовов, и с увеличением числа элементов последовательности количество повторов растет лавинообразно:![[Pasted image 20250323035929.png]]
...
![Лесенка состоит из нескольких рядов кубиков](https://media.proglib.io/posts/2023/01/17/b46b21af663b98f74779518c5fd10f5a.png)
